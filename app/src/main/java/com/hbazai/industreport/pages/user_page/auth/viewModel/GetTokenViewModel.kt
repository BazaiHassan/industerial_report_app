...
class GetTokenViewModel(private val authRepository: AuthRepository):ViewModel() {
    private val compositeDisposable = CompositeDisposable()
    val getTokenLiveData = MutableLiveData<ResponseSendOTP>()
    fun getToken(requestPhoneNumber: RequestPhoneNumber){
        authRepository.getToken(requestPhoneNumber).subscribeOn(Schedulers.io())
