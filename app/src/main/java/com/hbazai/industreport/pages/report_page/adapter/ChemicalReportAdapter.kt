...
class ChemicalReportAdapter :
    RecyclerView.Adapter<ChemicalReportAdapter.ReportViewHolder>() {

    inner class ReportViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView)

    private val differCallback = object : DiffUtil.ItemCallback<ResponseShowChemicalReportItem>() {
        override fun areItemsTheSame(
            oldItem: ResponseShowChemicalReportItem,
            newItem: ResponseShowChemicalReportItem
        ): Boolean {
