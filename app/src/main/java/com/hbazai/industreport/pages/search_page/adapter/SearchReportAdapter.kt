package com.hbazai.industreport.pages.search_page.adapter
...
class SearchReportAdapter :
    RecyclerView.Adapter<SearchReportAdapter.ReportViewHolder>() {

    inner class ReportViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView)

    private val differCallback = object : DiffUtil.ItemCallback<ResponseSearch>() {
